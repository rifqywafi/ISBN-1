<div id="lengkapiData">
            <div class="d-flex divider flex-row align-items-center justify-content-center justify-content-lg-start">
               <p class="text-center fw-bold mx-3 mt-4">Lengkapi Data Akun</p>
            </div>
            
            <div class="row">
               <div data-mdb-input-init class="col-sm-12 col-lg-6 form-outline mb-4">
                  <label class="form-label" for="nama">Nama Lengkap</label>
                  <input name="nama" type="text" id="nama" value="" class="form-control form-control-lg"
                  placeholder="Masukkan Nama Lengkap"  required/>
               </div>

               <div data-mdb-input-init class="col-sm-12 col-lg-6 form-outline mb-4">
                  <label class="form-label" for="email">Alamat Email</label>
                  <input name="email" type="email" value="" id="email" class="form-control form-control-lg"
