 ...
 *   https://datatables.net/download/#dt/dt-2.1.0
 *
 * Included libraries:
 *   DataTables 2.1.0
 */
...
!(function (n) {
          ...
          this.each(function () {
            ...
            if ("table" != this.nodeName.toLowerCase())
              ...
              if (t.aoColumns) h = t.aoColumns;
                ...
                for (O = n[(e = 0)].length; e < O; e++) h.push(null);
              ...
              if ((t.bStateSave && (N.bStateSave = !0), void 0 === t.aaSorting))
                for (var j = c.aaSorting, e = 0, O = j.length; e < O; e++)
              ...
              H.extend(!0, R, t.oLanguage),
                R.sUrl
                  ? H.ajax({
                      ...
                      success: function (t) {
                        q(a.oLanguage, t),
                          H.extend(!0, R, t, c.oInit.oLanguage),
                          G(c, null, "i18n", [c], !0),
                          Mt(c);
                      },
                      error: function () {
    ...
    e._hungarianMap || Z(e),
      H.each(n, function (t) {
        void 0 === (r = e._hungarianMap[t]) ||
          (!a && void 0 !== n[r]) ||
          ("o" === r.charAt(0)
            ? (n[r] || (n[r] = {}), H.extend(!0, n[r], n[t]), q(e[r], n[r], a))
            : (n[r] = n[t]));
      });
  }
  V.util = {
    ...
    if ("ssp" !== J(t))
      for (e = 0, n = u.length; e < n; e++) {
        if (((s = []), !(l = u[e]).sType && l._sManualType))
          ...
          for (a = 0, r = d.length; a < r; a++) {
            ...
            for (o = 0, i = c.length; o < i; o++)
              if (c[o]) {
                if (
                  (void 0 === s[o] && (s[o] = B(t, o, e, "type")),
                  h && !m && (m = lt(f, h(s[o], t))),
                  !(v = lt(f, p(s[o], t))) && a !== d.length - 3)
                )
                  break;
        ...
        if (b && !l._render) {
          ...
          for (var y, D = t, x = e, S = D.aoData, w = 0; w < S.length; w++)
            S[w].nTr &&
              ((y = B(D, w, x, "display")),
              (S[w].displayData[x] = y),
              ht(S[w].anCells[x], y));
    ...
    if (null === c.nTr) {
      for (
        ...
        (!u &&
          ...
          i.fnCreatedCell &&
            i.fnCreatedCell.call(t.oInstance, o, B(t, e, l), d, e, l);
      }
  ...
  function d(t, e, n) {
    ...
    (void 0 !== n && !0 !== n) ||
      (st(t),
      r && Jt(t),
      a ? Ot(t, t.oPreviousSearch) : (t.aiDisplay = t.aiDisplayMaster.slice())),
  ...
  function It(e) {
    ...
    n.oFeatures.bProcessing &&
      ...
      m ? a.prependTo(H("div.dt-scroll", n.nTableWrapper)) : a.insertBefore(t),
      ...
      for (
        ...
        if (c[d] && !(l = c[d])._aFilterData) {
          for (o = [], a = 0, r = u.length; a < r; a++)
            u[a].bSearchable
              ? "string" !=
                  typeof (i = null === (i = B(s, d, a, "filter")) ? "" : i) &&
                i.toString &&
                (i = i.toString())
              : (i = ""),
              i.indexOf &&
  ...
  function Mt(o) {
    ...
    o.bInitialised
      ? (wt(o, "header"),
        ...
        _t(o, o.aoFooter),
        (n = function () {
          if (s.aaData) for (i = 0; i < s.aaData.length; i++) D(o, s.aaData[i]);
            ...
            ("ssp" == c && !u) ||
              ("ajax" == c
                ? Ft(o, {}, function (t) {
                    ...
                    (o.iInitDisplayStart = l), d(o), w(o, !1), Ht(o);
                  })
                : (Ht(o), w(o, !1)));
        }),
  ...
  function Zt(t) {
    ...
    if (l.bSort && l.bSortClasses) {
      for (e = 0, n = r.length; e < n; e++)
        (a = r[e].src),
          H(f(t.aoData, "anCells", a)).removeClass(o + (e < 2 ? e + 1 : 3));
      for (e = 0, n = i.length; e < n; e++)
        (a = i[e].src),
          H(f(t.aoData, "anCells", a)).addClass(o + (e < 2 ? e + 1 : 3));
    }
    t.aLastSort = i;
  }
  function Qt(n) {
  ...
  function he(t, e, n, a, r, o) {
    for (var i = [], l = 0, s = r.length; l < s; l++) i.push(B(t, r[l], e, o));
    return i;
  }
  function pe(t, e, n) {
    var a = t.aoHeader;
            ...
            return (
              (e = se(
                ...
                function (n) {
                  ...
                  if (((i = i || me(r, o)), null !== t && -1 !== i.indexOf(t)))
                    return [t];
    ...
    Ne =
      ...
      V.type("date", {
        ...
        detect: {
          ...
          oneOf: function (t) {
            return t instanceof Date || ("string" == typeof t && O.test(t));
          },
        },
        order: {
          pre: function (t) {
            ...
            function (t, e) {
              ...
              d === e &&
                ...
                f
                  ...
                  .toggleClass(n.canAsc, r && l.includes("asc"))
                  .toggleClass(n.canDesc, r && l.includes("desc")),
                ...
                f.attr(
                  "aria-label",
                  r
                    ? a.ariaTitle + e.api.i18n("oAria.orderable" + o)
                    : a.ariaTitle
                ),
                r) &&
            ...
            (r.return && "Enter" !== t.key) ||
              (e != r.search &&
                Vt(n, a.processing, function () {
                  (r.search = e), Ot(n, r), (n._iDisplayStart = 0), S(n);
                }));
          }),
